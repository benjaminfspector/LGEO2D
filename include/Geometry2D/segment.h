...
template<class T> struct Segment
{
	...
	static bool operator==(const Segment<T> & s1, const Segment<T> & s2)
	{
...
typedef Segment<float> Segment2F;
typedef Segment<short> Segment2S;
typedef Segment<int> Segment2I;
typedef Segment<long> Segment2L;
typedef Segment<long long> Segment2LL;
